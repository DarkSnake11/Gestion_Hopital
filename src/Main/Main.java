...
public class Main {
    ...
    public static SshConsol sshConsol;
    public static consol.LocalConsol LocalConsol;
    ...
    public static void connexionLocalhost() {//pour console
        ...
        try {
            connexion connectSQL = new connexion(nameDatabase, loginDatabase,
                    passwordDatabase);
        } catch (Exception ex) {
