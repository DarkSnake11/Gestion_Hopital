...
public class BrowseElement extends JFrame {
    ...
    public BrowseElement(connexion connexion) {
        ...
        valider.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (finalColonne != "") {
                    ...
                    DisplaySQL sql = new DisplaySQL(connexion, choiceTab, finalColonne, nbElem);
