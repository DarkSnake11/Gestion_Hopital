...
public class RechercheElement extends JFrame {
    ...
    public RechercheElement(connexion connexion) {
        ...
        valider.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (finalColonne != "") {
                    ...
                    sql = new DisplaySQL(connexion, choiceTab, finalColonne, nbElem, affinage);
