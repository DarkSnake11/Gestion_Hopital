...
public class Graphisme extends JFrame {
    ...
    private graphisme.SSH SSH;
    private graphisme.LocalHosto Localhosto;
    ...
    public void choixMenu() {
        ...
        buttonLocalhost.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                LocalHosto LocalHosto = new LocalHosto();
                Main.mainWindow.afficherMenu(false);

                pan.add(LocalHosto.connectionLocalhostGraphique(true));
                pan.setVisible(false);
                LocalHosto.getFields();
